...
class Bot(commands.Bot):
    def __init__(self):
        ...
        self.role_message_id = 1026030849252143144  # ID of the message that can be reacted to to add/remove a role.
        self.emoji_to_role = {
            discord.PartialEmoji(
                name="🔴"
            ): 1020163559264628796,  # ID of the role Chicago associated with unicode emoji '🔴'.
            discord.PartialEmoji(
                name="🟢"
            ): 1020162194027069490,  # ID of the role Chicago associated with unicode emoji '🔴'.
        }
